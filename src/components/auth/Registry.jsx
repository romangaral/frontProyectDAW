            ...
            <div className="registry container-fluid">
                <div className="registry row">
                    <div className="registry col-md-12">
                        <div className="registryFormTitle"><h1 className="title">REGISTRO</h1></div>
                    </div>
                </div>
                <div className="registryForm row">
                    <div className="registry col-md-12">
                        ...
                        >
                            ...
                            <Button type="submit" variant="outline-success" >Registrarse</Button>
                            <Link to={'/'} className="returLink"><Button variant="outline-success" >Cancelar</Button></Link>
                        </Form>
                    </div>
                </div>
            </div>
