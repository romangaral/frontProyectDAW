...
function AddAdvertiser({ credentials }) {
    ...
    const onSubmit = async (value) => {
        let response = await fetch("http://localhost:8090/advertisers", {
            method: "POST",
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-md-12">
                            <div className="formTitle"><h2>Añadiendo un nuevo Anunciante:</h2></div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-12">
                            <AdvertisersForm value={advertiser} onSubmit={onSubmit} errors={errors} />
                        </div>
                    </div>
                </div>
            </Fragment>
